 ...
 **Exclusivo for Unit:** [Espadachín](/units/Swordsman/) 
...
## Subida de rango
  ...
  | **4x** <i class="fas fa-star"/> | ? | Aumenta la tenacidad en 200. |
  | **5x** <i class="fas fa-star"/> | ? | Aumenta su propia reducción de daño de unidad un 4% por cada unidad de Castillo en el campo de batalla. |
  | **6x** <i class="fas fa-star"/> | ? | <Matanza de Dragones> La reducción de daño de unidad del Espadachín aumenta un 20% cuando ataca a unidades de 1 o 4 miembros. Las unidades a corta distancia también obtienen un 20% de aumento de la velocidad de ataque. |
