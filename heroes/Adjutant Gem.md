...
## Extra bonus
  ...
  | **20** | <Asilo de la naturaleza> Restaura un 2% adicional de los PV máximos. La recarga es de 4 s. | - |
  | **30** | Aumenta la Inteligencia de un Héroe amistoso en 60 (todos los Héroes). | **+1500** |
  | **40** | <Asilo de la naturaleza> Tiene efecto sobre todas las facciones. | - |
