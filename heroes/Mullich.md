 ...
 **Especialidad de Héroe:** Asalto de carga
 ...
 **Mana recovery:** 5.0
  ...
  |---------|:---------------:|:---------------:|:--|--------------------|
  |    1    | 10 | 8 | **30x** [Mullich](/ItemsES/her_360/) | Las unidades de carga infligen un golpe crítico garantizado al atacar a objetivos aturdidos. |
  |    2    | 15 | 12 | **50x** [Mullich](/ItemsES/her_360/) | Las unidades de carga no pueden ser ralentizadas o aturdidas. |
  |    3    | 20 | 16 | **100x** [Mullich](/ItemsES/her_360/) | La velocidad de movimiento de las unidades de carga proporciona un aumento adicional a su ataque. |
  |    4    | 25 | 20 | **150x** [Mullich](/ItemsES/her_360/) | Todos los ataques normales de las unidades de carga tienen una probabilidad del 3% de infligir aturdimiento a su objetivo durante 2 s. |
 ...
 **Descripción 2:** Al siguiente nivel, la velocidad de ataque aumenta un <span style="color: #00ff22;font-size:16px">{$buffaddattr13}% adicional</span><span style="color: black">.

 **Descripción 3:** Los aliados reciben velocidad de ataque y de movimiento aumentadas.

 **Descripción 4:** Aumenta la velocidad de ataque y la velocidad de movimiento de las unidades amistosas.

### 4 Hechizo: Detener el tiempo
 ...
 **Descripción 4:** Invoca un campo de fuerza temporal en el que todo el movimiento se detiene.
