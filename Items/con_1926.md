 ...
 **Required Level to open:** 1
 ...
 You would need to choose 1 item from the list (0):
  ...
  |:---|:-------|:------------|:-----------:|
  | 1 | [Cofre de componente de venganza](/es/Items/con_1386/) | Un cofre de componente de Espejo de Venganza. Úsalo para seleccionar 1 de los componentes del artefacto Espejo de Venganza. | 
  ...
  | 4 | [Cofre de componente del tesoro](/es/Items/con_1383/) | Un cofre de componente del Códice del Archimago. Úsalo para seleccionar 1 de los componentes del artefacto Códice del Archimago. | 
